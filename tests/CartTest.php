...
class CartTest extends PHPUnit\Framework\TestCase
{
    ...
    public function test_sub_total_when_item_quantity_is_updated()
    {
        ...
        $this->assertEqualsWithDelta(273.22, $this->cart->getSubTotal(), 0.01, 'Cart should have sub total of 273.22');

        // when cart's item quantity is updated, the subtotal should be updated as well
        $this->cart->update(456, array('quantity' => 2));

        $this->assertEqualsWithDelta(409.2, $this->cart->getSubTotal(), 0.01, 'Cart should have sub total of 409.2');
    }
    ...
    public function test_sub_total_when_item_quantity_is_updated_by_reduced()
    {
        ...
        $this->assertEqualsWithDelta(205.23, $this->cart->getSubTotal(), 0.01, 'Cart should have sub total of 205.23');
    }
